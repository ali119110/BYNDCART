...
import { getStoreCustomers } from "../services/customers.server";
          ...
          <s-stack direction="block" gap="base">
            ...
            >
              ...
              <s-paragraph tone="neutral">
                Customer profiles compile automatically as orders and return
          ...
          >
            <thead>
              <tr style={{ borderBottom: "1px solid #e1e3e5" }}>
                ...
                <th style={{ padding: "12px 8px" }}>
                  <s-text tone="neutral">Orders</s-text>
                </th>
                <th style={{ padding: "12px 8px" }}>
                  <s-text tone="neutral">Returns</s-text>
                </th>
                <th style={{ padding: "12px 8px" }}>
                  <s-text tone="neutral">Exchanges</s-text>
                </th>
                <th style={{ padding: "12px 8px" }}>
                  <s-text tone="neutral">Total Refunded (PKR)</s-text>
                </th>
                <th style={{ padding: "12px 8px" }}>
                  <s-text tone="neutral">Return Rate</s-text>
                </th>
                <th style={{ padding: "12px 8px" }}>
                  <s-text tone="neutral">Risk Profile</s-text>
                </th>
              ...
              {customers.map((c) => (
                <tr
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    backgroundColor:
                      selectedCustomer?.id === c.id ? "#f4f6f8" : "transparent",
                  }}
                >
                  ...
                  <td style={{ padding: "12px 8px" }}>
                    <strong>
                      Rs. {(c.totalRefundedPKR ?? 0).toLocaleString()}
                    </strong>
                  </td>
                  <td style={{ padding: "12px 8px" }}>
                    <s-text
                      tone={
                        parseFloat(c.returnRate) > 30 ? "critical" : "neutral"
                      }
                    >
                      {c.returnRate}
                    </s-text>
                  ...
                  <td style={{ padding: "12px 8px" }}>
                    <s-badge
                      tone={c.riskFlag?.flagged ? "critical" : "success"}
                    >
                  ...
                  >
                    <s-button onClick={() => setSelectedCustomer(c)}>
                      View Details
                    </s-button>
                  </td>
                </tr>
        ...
        >
          ...
          >
            ...
            >
              ...
              <s-button onClick={() => setSelectedCustomer(null)}>
                Close
              </s-button>
            </div>
            ...
            <div style={{ margin: "16px 0" }}>
              <s-badge
                tone={
                  selectedCustomer.riskFlag?.flagged ? "critical" : "success"
                }
              >
                {selectedCustomer.riskFlag?.flagged
                  ? "High Risk Account"
                  : "Standard Account"}
              </s-badge>
            </div>

            {selectedCustomer.riskFlag?.reasons &&
              selectedCustomer.riskFlag.reasons.length > 0 && (
                <div style={{ marginBottom: "16px" }}>
                  <s-box
                    padding="base"
                    borderWidth="base"
                  ...
                  >
                    ...
                    <ul style={{ margin: "8px 0 0 16px", padding: 0 }}>
                      {selectedCustomer.riskFlag.reasons.map((r, i) => (
                        <li
                          key={i}
                          style={{ fontSize: "13px", color: "#d72c0d" }}
                        >
                          {r}
                        </li>
                      ))}
            ...
            >
              ...
              >
                ...
                <div style={{ fontSize: "18px", fontWeight: "bold" }}>
                  {selectedCustomer.returnsCount} /{" "}
                  {selectedCustomer.exchangesCount}
                </div>
              </s-box>
              <s-box
                padding="base"
              ...
              >
                ...
                <div style={{ fontSize: "18px", fontWeight: "bold" }}>
                  Rs.{" "}
                  {(selectedCustomer.totalRefundedPKR ?? 0).toLocaleString()}
                </div>
              </s-box>
            </div>
            ...
            <div style={{ marginTop: "8px" }}>
              {!selectedCustomer.recentReturns ||
