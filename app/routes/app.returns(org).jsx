...
import { mockReturns } from "../mocks/byndcartMocks";
          ...
          <s-stack direction="block" gap="base">
            ...
            >
              ...
              <s-paragraph tone="neutral">
                Adjust your queries or filters and try again.
              </s-paragraph>
            </div>
          </s-stack>
        ) : (
              ...
              <tbody>
                {paginatedReturns.map((ret) => (
                  ...
                  >
                    ...
                    >
                      <s-button onClick={() => setSelectedReturn(ret)}>
                        View Details
                      </s-button>
                    </td>
                  </tr>
                ...
                {selectedReturn.status === "Pending" ? (
                  ...
                  <>
                    <s-button
                      variant="primary"
                      onClick={() =>
                        handleUpdateStatus(selectedReturn.id, "In Transit")
                      }
                    >
                  ...
                  <>
                    <s-button
                      variant="primary"
                      onClick={() =>
                        handleUpdateStatus(selectedReturn.id, "Received")
                      }
                    >
                  ...
                  <s-text tone="neutral">
                    No outstanding actions. Return is closed.
                  </s-text>
                )}
              </div>
            </div>
