...
export default function Analytics() {
  ...
  const { summary, returnReasons, monthlyTrend, topReturnedProducts } =
    analytics;
  ...
  const maxProductReturnCount = Math.max(
    1,
    ...topReturnedProducts.map((p) => p.returnCount),
  );
        ...
        >
          ...
          >
            <s-stack direction="block" gap="small">
              ...
              <s-text tone="neutral">
                {summary.totalReturns} of {summary.totalRequests} requests
              </s-text>
            </s-stack>
          </s-box>
          ...
          >
            <s-stack direction="block" gap="small">
              ...
              <s-text tone="neutral">
                {summary.totalExchanges} of {summary.totalRequests} requests
              </s-text>
            </s-stack>
          </s-box>
          ...
          >
            <s-stack direction="block" gap="small">
              ...
              <s-heading>
                Rs. {(summary.totalRefunded || 0).toLocaleString()}
              </s-heading>
          ...
          >
            <s-stack direction="block" gap="small">
              ...
              <s-heading>
                Rs. {(summary.revenueFromExchanges || 0).toLocaleString()}
              </s-heading>
              <s-text tone="neutral">
                Net revenue retained from exchanges
              </s-text>
            </s-stack>
          </s-box>
        </div>
        ...
        <div style={{ marginBottom: "20px" }}>
          ...
          >
            <s-stack direction="block" gap="base">
              <s-paragraph>
                Volume of returns vs exchanges over the last 6 months.
              </s-paragraph>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                <thead>
                  ...
                  >
                    ...
                    <th style={{ padding: "8px 0" }}>
                      <s-text tone="neutral">Occurrences</s-text>
                    </th>
                    <th style={{ padding: "8px 0" }}>
                      <s-text tone="neutral">Share</s-text>
                    </th>
                  </tr>
                </thead>
                <tbody>
        ...
        >
          <s-stack direction="block" gap="base">
            ...
            {topReturnedProducts.length === 0 ? (
              <s-text tone="neutral">
                No data yet. This populates once orders have synced (Orders page
                → Sync Orders) and returns exist against them.
              </s-text>
            ) : (
              <s-stack direction="block" gap="small">
