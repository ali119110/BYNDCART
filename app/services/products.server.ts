 ...
 */
export async function getProductByVariantId(shopifyStoreId: string, shopifyVariantId: string) {
 ...
 */
export async function upsertProductCache(shopifyStoreId: string, variant: CachedVariant) {
 ...
 */
export async function fetchVariantFromShopify(admin: any, shopifyVariantId: string): Promise<CachedVariant | null> {
 ...
 */
export async function getOrCacheVariant(admin: any, shopifyStoreId: string, shopifyVariantId: string) {
 ...
 */
export async function upsertVariantsFromWebhook(shopifyStoreId: string, productPayload: any) {
