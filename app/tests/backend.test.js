...
prisma.session.create = async () => null;
prisma.session.update = async () => null;
prisma.session.deleteMany = async () => null;
prisma.shopifyStore.findUnique = async () => null;
prisma.shopifyStore.findFirst = async () => null;
prisma.user.findUnique = async () => null;
prisma.user.create = async () => null;
...
test("Tenant Resolution - Unauthenticated session rejection", async () => {
  ...
  try {
    ...
    assert.fail(
      "Should have thrown Response error for unauthenticated session",
    );
  } catch (error) {
